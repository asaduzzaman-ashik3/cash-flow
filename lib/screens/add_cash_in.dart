...
class _AddCashInState extends State<AddCashIn> {
  ...
  final TextEditingController _husbandWifeSalaryController = TextEditingController();
  final TextEditingController _sonDaughterSalaryController = TextEditingController();
  final TextEditingController _fatherMotherSalaryController = TextEditingController();
  ...
  final TextEditingController _agricultureEarnController = TextEditingController();
  final TextEditingController _animalIncreasingEarnController = TextEditingController();
  final TextEditingController _treeSellsEarnController = TextEditingController();
  final TextEditingController _fruitSellEarnController = TextEditingController();
    ...
    try {
      ...
      if (mounted) {
        setState(() {
          ...
          _husbandWifeSalaryController.text = prefs.getString('husband_wife_salary') ?? '';
          _sonDaughterSalaryController.text = prefs.getString('son_daughter_salary') ?? '';
          _fatherMotherSalaryController.text = prefs.getString('father_mother_salary') ?? '';
          _savingsEarnController.text = prefs.getString('savings_earn') ?? '';
          _homeRentEarnController.text = prefs.getString('home_rent_earn') ?? '';
          _businessEarnController.text = prefs.getString('business_earn') ?? '';
          _agricultureEarnController.text = prefs.getString('agriculture_earn') ?? '';
          _animalIncreasingEarnController.text = prefs.getString('animal_increasing_earn') ?? '';
          _treeSellsEarnController.text = prefs.getString('tree_sells_earn') ?? '';
          _fruitSellEarnController.text = prefs.getString('fruit_sell_earn') ?? '';
  ...
  Future<void> _saveValues() async {
    try {
      ...
      final saveResults = await Future.wait([
        ...
        prefs.setString('husband_wife_salary', _husbandWifeSalaryController.text.trim()),
        prefs.setString('son_daughter_salary', _sonDaughterSalaryController.text.trim()),
        prefs.setString('father_mother_salary', _fatherMotherSalaryController.text.trim()),
        ...
        prefs.setString('agriculture_earn', _agricultureEarnController.text.trim()),
        prefs.setString('animal_increasing_earn', _animalIncreasingEarnController.text.trim()),
        prefs.setString('tree_sells_earn', _treeSellsEarnController.text.trim()),
        prefs.setString('fruit_sell_earn', _fruitSellEarnController.text.trim()),
          ...
          child: Column(
            children: [
              ...
              Row(
                children: [
                  Expanded(
                    child: _buildTextField('Own Salary', _ownSalaryController),
                  ),
